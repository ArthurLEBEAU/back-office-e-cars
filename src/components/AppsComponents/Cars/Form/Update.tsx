import {
  ...
  function FormUpdateCars({ close, car }: any) {
    ...
    // const Validates = async (formData: any) => {
    //     const contactSecondaire =
    //       formData.contacts.length === 0
    //         ? ""
    //         : formData.contacts === undefined ||
    //           formData.contacts["contacts"] === undefined
    //         ? undefined
    //         : formData.contacts["contacts"];

    //     const formValue = {
    //       name: formData.name !== client.name ? formData.name : undefined,
    //       honorific:
    //         formData.honorific !== client.honorific
    //           ? formData.honorific
    //           : undefined,
    //       photo:
    //         formData.photo === undefined
    //           ? undefined
    //           : formData.photo?.file?.status === "removed"
    //           ? undefined
    //           : formData.photo.file,
    //       sex: formData.sex !== client.sex ? formData.sex : undefined,
    //       email: formData.email !== client.email ? formData.email : undefined,
    //       contact:
    //         formData.contact !== client.contact ? formData.contact : undefined,
    //       contacts:
    //         contactSecondaire !== client.contacts ? contactSecondaire : undefined,
    //       profession:
    //         formData.profession !== client.profession
    //           ? formData.profession
    //           : undefined,
    //       type_piece:
    //         formData.type_piece !== client.type_piece
    //           ? formData.type_piece
    //           : undefined,
    //       num_piece:
    //         formData.num_piece !== client.num_piece
    //           ? formData.num_piece
    //           : undefined,
    //     };
